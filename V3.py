...
class Transacao:
    def registrar(self, conta):
        sucesso_transacao = self.executar_transacao(conta)

        if sucesso_transacao:
            conta.historico.adicionar_transacao(self)

    def executar_transacao(self, conta):
        raise NotImplementedError("Subclasses of Transacao must implement executar_transacao method.")
